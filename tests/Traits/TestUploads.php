...
trait TestUploads
{
    protected function assertInvalidationFile(string $field, string $extension, string $maxSize, string $rule, array $ruleParams = [])
    {
        $routes = [
            [
                'method' => 'POST',
        ...
        foreach ($routes as $route) {
            $file = UploadedFile::fake()->create("$field.3$extension");
